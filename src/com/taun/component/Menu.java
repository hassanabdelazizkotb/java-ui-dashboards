...
import com.taun.event.EventMenuSelected;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listMenu1 = new com.taun.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/taun/icon/logo.png"))); // NOI18N
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#1AB5E0"), 0, getHeight(), Color.decode("#AA5005"));
        g2.setPaint(g);
    ...
    private com.taun.swing.ListMenu<String> listMenu1;
